...
Version  : 0.7.30
Release  : 36
URL      : https://github.com/openSUSE/libsolv/archive/0.7.30/libsolv-0.7.30.tar.gz
Source0  : https://github.com/openSUSE/libsolv/archive/0.7.30/libsolv-0.7.30.tar.gz
...
%prep
%setup -q -n libsolv-0.7.30
cd %{_builddir}/libsolv-0.7.30
pushd ..
cp -a libsolv-0.7.30 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722353404
mkdir -p clr-build
pushd clr-build
...
-DENABLE_ZSTD_COMPRESSION=ON  -G 'Unix Makefiles'
make  %{?_smp_mflags}
popd
pushd ../buildavx2/
