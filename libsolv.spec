...
Version  : 0.6.34
Release  : 12
URL      : https://github.com/openSUSE/libsolv/archive/0.6.34.tar.gz
Source0  : https://github.com/openSUSE/libsolv/archive/0.6.34.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1531426360
mkdir clr-build
pushd clr-build
