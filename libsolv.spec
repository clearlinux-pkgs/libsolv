...
Version  : 0.7.11
Release  : 24
URL      : https://github.com/openSUSE/libsolv/archive/0.7.11/libsolv-0.7.11.tar.gz
Source0  : https://github.com/openSUSE/libsolv/archive/0.7.11/libsolv-0.7.11.tar.gz
...
%prep
%setup -q -n libsolv-0.7.11
cd %{_builddir}/libsolv-0.7.11
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1579800960
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/libsolv-0.7.11/LICENSE.BSD %{buildroot}/usr/share/package-licenses/libsolv/b965854f0ddcbff41631dee1f018ba72e2f248ff
pushd clr-build
%make_install
popd
