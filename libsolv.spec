...
Version  : 0.7.29
Release  : 34
URL      : https://github.com/openSUSE/libsolv/archive/0.7.29/libsolv-0.7.29.tar.gz
Source0  : https://github.com/openSUSE/libsolv/archive/0.7.29/libsolv-0.7.29.tar.gz
...
%prep
%setup -q -n libsolv-0.7.29
cd %{_builddir}/libsolv-0.7.29
pushd ..
cp -a libsolv-0.7.29 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719971176
mkdir -p clr-build
pushd clr-build
...
-DENABLE_RPMMD=YES \
-DENABLE_LZMA_COMPRESSION=NO \
-DENABLE_ZCHUNK_COMPRESSION=OFF  -G 'Unix Makefiles'
make  %{?_smp_mflags}
popd
pushd ../buildavx2/
...
cp %{_builddir}/libsolv-%{version}/LICENSE.BSD %{buildroot}/usr/share/package-licenses/libsolv/b965854f0ddcbff41631dee1f018ba72e2f248ff || :
cp %{_builddir}/libsolv-%{version}/win32/LICENSE %{buildroot}/usr/share/package-licenses/libsolv/bf81e90c601de42748bc87dfbee410eabd40cf90 || :
export GOAMD64=v2
pushd ../buildavx2/
GOAMD64=v3
pushd clr-build-avx2
...
%files bin
%defattr(-,root,root,-)
/V3/usr/bin/deltainfoxml2solv
/V3/usr/bin/dumpsolv
/V3/usr/bin/installcheck
/V3/usr/bin/mergesolv
/V3/usr/bin/repo2solv
/V3/usr/bin/repomdxml2solv
/V3/usr/bin/rpmdb2solv
/V3/usr/bin/rpmmd2solv
/V3/usr/bin/rpms2solv
/V3/usr/bin/testsolv
/V3/usr/bin/updateinfoxml2solv
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libsolv.so.1
/V3/usr/lib64/libsolvext.so.1
