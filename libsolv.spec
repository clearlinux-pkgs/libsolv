...
Version  : 0.7.20
Release  : 29
URL      : https://github.com/openSUSE/libsolv/archive/0.7.20/libsolv-0.7.20.tar.gz
Source0  : https://github.com/openSUSE/libsolv/archive/0.7.20/libsolv-0.7.20.tar.gz
...
%prep
%setup -q -n libsolv-0.7.20
cd %{_builddir}/libsolv-0.7.20
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1632765630
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/libsolv-0.7.20/LICENSE.BSD %{buildroot}/usr/share/package-licenses/libsolv/b965854f0ddcbff41631dee1f018ba72e2f248ff
cp %{_builddir}/libsolv-0.7.20/win32/LICENSE %{buildroot}/usr/share/package-licenses/libsolv/bf81e90c601de42748bc87dfbee410eabd40cf90
pushd clr-build
%make_install
popd
