...
Version  : 0.6.32
Release  : 9
URL      : https://github.com/openSUSE/libsolv/archive/0.6.32.tar.gz
Source0  : https://github.com/openSUSE/libsolv/archive/0.6.32.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1518531012
mkdir clr-build
pushd clr-build
