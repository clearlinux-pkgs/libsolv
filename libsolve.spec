...
Summary  : Library for reading repositories
Group    : Development/Tools
License  : BSD-3-Clause
Requires: libsolve-bin
Requires: libsolve-lib
Requires: libsolve-data
Requires: libsolve-doc
BuildRequires : cmake
...
%package bin
Summary: bin components for the libsolve package.
Group: Binaries
Requires: libsolve-data

%description bin
bin components for the libsolve package.


%package data
Summary: data components for the libsolve package.
Group: Data

%description data
data components for the libsolve package.


%package dev
Summary: dev components for the libsolve package.
Group: Development
Requires: libsolve-lib
Requires: libsolve-bin
Requires: libsolve-data
Provides: libsolve-devel

%description dev
dev components for the libsolve package.


%package doc
Summary: doc components for the libsolve package.
Group: Documentation

%description doc
doc components for the libsolve package.


%package lib
Summary: lib components for the libsolve package.
Group: Libraries
Requires: libsolve-data

%description lib
lib components for the libsolve package.


%prep
%setup -q -n libsolv-0.6.29
...
export LANG=C
export SOURCE_DATE_EPOCH=1507662375
mkdir clr-build
pushd clr-build
